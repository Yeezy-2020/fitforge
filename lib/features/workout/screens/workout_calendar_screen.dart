    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        AnimatedSize(duration: const Duration(milliseconds: 250), curve: Curves.easeInOut, alignment: Alignment.topCenter,
          child: _collapsed ? const SizedBox.shrink() : Column(children: [
            TableCalendar(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(child: Icon(Icons.keyboard_arrow_up, size: 20, color: Colors.grey.shade500)),
              ),
            ),
          ]),
        ),
        // Expand handle (only when collapsed)
        if (_collapsed)
          GestureDetector(
            ...
            child: Container(
              padding: const EdgeInsets.symmetric(vertical: 6),
              color: Theme.of(context).colorScheme.surfaceContainerHighest.withValues(alpha: 0.5),
              child: Center(child: Icon(Icons.keyboard_arrow_down, size: 20, color: Colors.grey.shade500)),
            ),
          ),
        // Content area
        Expanded(
          child: _selectedDay == null
              ...
              : logs.isEmpty
                  ...
                  : ReorderableListView.builder(
                      shrinkWrap: false, padding: const EdgeInsets.all(8), itemCount: logs.length,
                      onReorder: (oldI, newI) {
