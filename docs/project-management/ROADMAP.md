...
- Full smoke checklist for program creation, edit, activation, date scheduling, pause/resume/end, deload, logging, and advancement.
...
- Remaining cycle-vs-week wording cleanup.
