...
import 'package:fitforge/core/theme/metallic_surface.dart';
...
final testExercises = [
  ...
  Exercise(
    ...
    instructions: '1. Grip bar\n2. Pull up\n3. Lock out',
    commonMistakes: 'Rounded back',
  ),
];
...
Widget testApp({
  ...
  return ProviderScope(
    ...
    child: MaterialApp(
      ...
      home: MetallicBackground(
        child: SizedBox(width: goldenWidth, height: goldenHeight, child: child),
      ),
    ),
  );
}
...
Future<void> expectGolden(
  ...
  tester.view.physicalSize = const Size(goldenWidth, goldenHeight);
